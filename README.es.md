...
[![Versión](https://img.shields.io/badge/versión-2.0--magnum--opus-D4AF37?style=for-the-badge&logo=flask&logoColor=white)](https://github.com/smouj/alchemical-agent-ecosystem)
[![Licencia](https://img.shields.io/github/license/smouj/alchemical-agent-ecosystem?style=for-the-badge&color=16a34a)](LICENSE)
[![Último commit](https://img.shields.io/github/last-commit/smouj/alchemical-agent-ecosystem?style=for-the-badge)](https://github.com/smouj/alchemical-agent-ecosystem/commits/main)
...
&nbsp;
<strong><img src="https://img.shields.io/badge/Idioma-Español-c92a2a?style=for-the-badge" alt="Español"></strong>
...
sequenceDiagram
  autonumber
  actor U as Operador
  participant UI as Agent Node Studio
  ...
  UI->>GW: POST /api/v1/tasks {workflow_graph}
  GW->>GW: Valida RBAC + API key + límites
  GW->>SY: Despacha grafo de trabajo
  SY->>MEM: Consulta contexto histórico relevante
  ...
  SY->>SY: Consolida y valida resultados
  SY-->>GW: Resultado final
  GW-->>UI: Respuesta enriquecida con metadata
  UI-->>U: Visualización del resultado
```
...
[![Issues](https://img.shields.io/github/issues/smouj/alchemical-agent-ecosystem)](https://github.com/smouj/alchemical-agent-ecosystem/issues)
